<#
.SYNOPSIS
Update an Intacct attachment folder.
...
.LINK
https://developer.intacct.com/api/company-console/attachments/#update-attachment-folder-legacy
#>

function Set-IntacctAttachmentFolder {
    ...
    process {
        ...
        [void]$SB.Append("<update_supdocfolder>")
        ...
        if ( $PSCmdlet.ShouldProcess($supdocfoldername, 'Set-IntacctAttachmentFolder') )
        {
